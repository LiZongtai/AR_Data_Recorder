...
import tongji.lzt.ar_data_recorder.util.ErrorInfo;

public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    protected AMapNaviView mAMapNaviView;
    protected AMapNavi mAMapNavi;
    protected NaviLatLng mEndLatlng = new NaviLatLng(31.021954166666667,121.4420525);
    protected NaviLatLng mStartLatlng = new NaviLatLng(31.02606722222222,121.42707972222222);
...
//        mAMapNavi.stopNavi();
    ...
    protected void onDestroy() {
        ...
        //since 1.6.0 不再在navi view destroy的时候自动执行AMapNavi.stopNavi();请自行执行
        mAMapNavi.stopNavi();
        mAMapNavi.destroy();
    }
    @Override
    ...
    public void onLocationChange(AMapNaviLocation location) {
        //当前位置回调
        Log.i("YJNTest","location:" + location.toString());
    }

    @Override
    public void onGetNavigationText(int type, String text) {
        //播报类型和播报文字回调
        Log.i("YJNTest","GetNaniText:"+type+text);
    }

    @Override
    public void onGetNavigationText(String s) {
        Log.i("YJNTest","NaviTextString:" + s);
    }
    ...
    public void onNaviInfoUpdate(NaviInfo naviinfo) {
        ...
        Log.i("YJNTest","NaviInfo:"+naviinfo.getCurrentRoadName()+naviinfo.getCurrentSpeed()+
